class Komac < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      def install
        bin.install "komac-2.3.0-x86_64-apple-darwin" => "komac"
      end
    end
    if Hardware::CPU.arm?
      ...
      def install
        bin.install "komac-2.3.0-aarch64-apple-darwin" => "komac"
      end
    end
  end
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      ...
      def install
        bin.install "komac-2.3.0-x86_64-unknown-linux-gnu" => "komac"
      end
    end
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      ...
      def install
        bin.install "komac-2.3.0-aarch64-unknown-linux-gnu" => "komac"
      end
    end
  end
